...
//! Paged addresses are mapped to Global for programming etc
...
void makeLinearAddress(uint32_t *address) {
   ...
   tryDFlash:
      ...
      cmpb  #0x14                  // >=0x1400
      bhs   doPFlash               // No  - must be unpaged PFlash
...
//   /* flags      */ DO_INIT_FLASH|DO_ERASE_RANGE|DO_BLANK_CHECK_RANGE|DO_PROGRAM_RANGE|DO_VERIFY_RANGE,
   /* flags      */ DO_INIT_FLASH|DO_VERIFY_RANGE,
   /* errorCode  */ 0xAA55,
