//!
//! Flash programming code (HCS12-XMMC-XFTMRK-flash-program)
//!
//! Families
//!   MC9S12XEP
//!   MC9S12XF
...
//!   S12XMMCV4
//!
//! Global flash programming (FTMR uses global addresses directly)
//! Paged addresses are mapped to Global for programming
//! CPU Memory accesses use GPAGE and CPU12X-extensions
//!
//!   S12XFTMR256K1V1 - 256K P-flash (256x1024B sectors), 8K D-flash (32x256B sectors)
//!   S12XFTMR128K1V1 - 128K P-flash,(128x1024B sectors), 8K D-flash (32x256B sectors)
//!   S12XFTMR64K1V1  -  64K P-flash,( 64x1024B sectors), 4K D-flash (16x256B sectors)
//!
...
//! History
//!------------------------------------------------------------------------------
//! Fixed makeLinearAddress() mapping for paged DFlash                 V4.10.4
//!==============================================================================
...
#define GPAGE 0x10
#define PFLASH_LOW   (0x400000) // Lowest Global address for P-Flash (assume D-Flash below)
